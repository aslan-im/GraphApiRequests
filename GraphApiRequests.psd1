...
@{
    ...
    FileList = @(
        ".\Functions\Private\Get-GraphDeviceAuthCode.ps1",
        ".\Functions\Private\New-GraphAuthFormWindow.ps1",
        ".\Functions\Public\Get-GraphToken.ps1",
        ".\Functions\Public\Get-GraphDeviceAuthToken.ps1",
        ".\Functions\Public\Invoke-GraphApiRequest.ps1"
    )
